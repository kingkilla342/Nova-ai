...
export default function ChatPanel({ messages, onSend, loading, project, onUpload }) {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header */}
      <div className="flex-shrink-0 px-4 py-2.5 border-b border-[rgba(0,255,106,0.1)] flex items-center justify-between hud-panel">
        <div className="flex items-center gap-2.5 relative z-10">
          <div className="w-6 h-6 rounded-full border border-[rgba(0,255,106,0.3)] flex items-center justify-center radar" style={{ width: 22, height: 22 }}>
            <div className="w-1.5 h-1.5 rounded-full bg-hud-green" />
          </div>
          <div>
            <span className="font-display text-[11px] text-hud-green font-semibold tracking-[0.2em]">NOVA AI</span>
            <span className="font-mono text-[8px] text-hud-text-dim ml-2 tracking-wider">
        ...
        <div className="flex items-end gap-2 relative z-10">
          ...
          <div className="flex-1">
            <textarea
              ...
              rows={1}
              className="w-full px-3 py-2 rounded hud-input text-sm resize-none font-mono"
          ...
          <button
            ...
            className="flex-shrink-0 w-8 h-8 rounded hud-btn flex items-center justify-center disabled:opacity-20 disabled:cursor-not-allowed"
          >
