        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-mono text-[14px] text-hud-text-dim tracking-[0.3em]">DETAILS</span>
              <div className="flex-1 h-px bg-[rgba(0,255,106,0.1)]" />
            </div>
            <div className="space-y-2">
              {[
                ...
                <div key={label} className="flex justify-between items-center">
                  <span className="font-mono text-[13px] text-hud-text-dim tracking-wider">{label}</span>
                  <span className="font-mono text-[13px] text-hud-text-bright">{value}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="flex-1 h-px bg-[rgba(0,255,106,0.1)]" />
              <span className="font-mono text-[14px] text-hud-text-dim tracking-[0.3em]">TIMELINE</span>
              <div className="flex-1 h-px bg-[rgba(0,255,106,0.1)]" />
            </div>
            <div className="space-y-2">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="flex-1 h-px bg-[rgba(0,255,106,0.1)]" />
              <span className="font-mono text-[14px] text-hud-text-dim tracking-[0.3em]">METRICS</span>
              <div className="flex-1 h-px bg-[rgba(0,255,106,0.1)]" />
            </div>
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <div key={label} className="hud-panel hud-corners rounded-lg p-3 text-center">
                  <div className="font-display text-3xl text-hud-green text-glow font-bold">{value}</div>
                  <div className="font-mono text-[14px] text-hud-text-dim mt-0.5 tracking-[0.2em]">{label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="flex-1 h-px bg-[rgba(0,255,106,0.1)]" />
              <span className="font-mono text-[14px] text-hud-text-dim tracking-[0.3em]">EXPORT</span>
              <div className="flex-1 h-px bg-[rgba(0,255,106,0.1)]" />
            </div>
            <button className="w-full hud-btn px-4 py-3 rounded font-display text-[13px] tracking-[0.2em] opacity-50 cursor-not-allowed" disabled>
