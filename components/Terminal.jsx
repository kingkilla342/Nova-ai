...
export default function Terminal({ logs }) {
  ...
  return (
    <div className="h-full flex flex-col" style={{ background: '#020804' }}>
      {/* Header */}
      <div className="flex-shrink-0 h-9 px-3 border-b border-[rgba(0,255,106,0.1)] flex items-center justify-between hud-panel relative z-10">
        <div className="flex items-center gap-2">
          <span className="font-display text-[12px] text-hud-green font-semibold tracking-[0.2em]">TERMINAL</span>
        ...
        <span className="font-mono text-[12px] text-hud-text-dim tracking-wider">{logs.length} ENTRIES</span>
      </div>

      {/* Log output */}
      <div className="flex-1 overflow-y-auto px-4 py-2.5 font-mono text-[12px] leading-[18px]">
        {logs.map((log, i) => (
